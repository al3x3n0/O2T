#!/usr/bin/env python3
"""Generate and run CBMC/ESBMC harnesses for source-mined DCE erasures."""
...
from o2t.symexec.modelcheck_dce import run_dce_source_modelcheck  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--widths", default="native",
                        help="comma-separated bit-width replay set, or native for one 32-bit structural run")
    parser.add_argument("--summary-json", type=Path)
    parser.add_argument("--report", type=Path, help="Alias for --summary-json")
    args = parser.parse_args()

    summary = run_dce_source_modelcheck(
        args.source,
        args.out_dir,
        args.engine,
        args.unwind,
