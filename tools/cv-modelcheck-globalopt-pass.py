#!/usr/bin/env python3
"""Generate and run CBMC/ESBMC harnesses for source-mined GlobalOpt folds."""
...
from o2t.symexec.modelcheck_globalopt import run_globalopt_source_modelcheck  # noqa: E402
...
def main() -> int:
    ...
    summary = run_globalopt_source_modelcheck(
        args.source,
        args.out_dir,
        args.engine,
        args.unwind,
