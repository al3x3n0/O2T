...
Value *loadUnsafeMaskIndexMemory(Value **Base, Value **Mask, Value **Passthru,
                                 IRBuilder &Builder) {
  Value *L0 = Builder.CreateMaskedLoad(Base[0], Mask[nextLane()], Passthru[0]);
