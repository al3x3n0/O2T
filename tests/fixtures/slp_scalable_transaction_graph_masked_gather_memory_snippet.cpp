...
Value *loadMaskedGatherPack(Value **Base, Value **Mask, Value **Passthru,
                            IRBuilder &Builder) {
...
void vectorizeScalableMaskedGatherMemoryTree(TreeEntry &Entry, Value **A,
  ...
  if (allSameOpcode(Entry, Instruction::Add) && isValidElementType(Entry) &&
    ...
    Value *LHS = loadMaskedGatherPack(A, Mask, Passthru, Builder);
