...
Value *loadGatherPack(Value **Base, IRBuilder &Builder) {
...
void vectorizeScalableGatherScatterMemoryTree(TreeEntry &Entry, Value **In,
  ...
  if (allSameOpcode(Entry, Instruction::Add) && isValidElementType(Entry) &&
    ...
    Value *LHS = loadGatherPack(In, Builder);
