...
extern int DynamicMask[4];

void vectorizeUnresolvedShuffleTree(TreeEntry &Entry, IRBuilder &Builder,
  ...
  if (allSameOpcode(Entry, Instruction::Add) && isValidElementType(Entry) &&
    ...
    Value *VectorShuffle = Builder.CreateShuffleVector(VectorAdd, DynamicMask);
