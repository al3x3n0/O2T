...
Value *loadStaticGatherPack(Value **Base, IRBuilder &Builder) {
...
void vectorizeScalableGatherMemoryPackTree(TreeEntry &Entry, Value **A,
                                           IRBuilder &Builder,
  ...
  if (allSameOpcode(Entry, Instruction::Add) && isValidElementType(Entry) &&
    ...
    Value *LHS = loadStaticGatherPack(A, Builder);
