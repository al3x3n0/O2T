...
Value *loadScalableUnsafeMaskIndexPack(Value **Base, Value **Mask,
                                       Value **Passthru,
                                       IRBuilder &Builder) {
...
void vectorizeScalableUnsafeMaskIndexMemoryTree(
  ...
  if (allSameOpcode(Entry, Instruction::Add) && isValidElementType(Entry) &&
    ...
    Value *LHS = loadScalableUnsafeMaskIndexPack(In, Mask, Passthru, Builder);
