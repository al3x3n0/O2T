...
void vectorizeExtractInsertUnresolvedTree(TreeEntry &Entry, IRBuilder &Builder,
  ...
  if (allSameOpcode(Entry, Instruction::Add) && isValidElementType(Entry) &&
    ...
    unsigned LaneIndex = chooseLane(Entry);
    Value *Lane = Builder.CreateExtractElement(VectorAdd, LaneIndex);
