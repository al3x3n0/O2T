...
Value *loadSymbolicMaskIndexMemory(Value **Base, Value **Mask,
...
void vectorizeSymbolicMaskIndexMemoryTree(TreeEntry &Entry, Value **In,
  ...
  if (allSameOpcode(Entry, Instruction::Add) && isValidElementType(Entry) &&
    ...
    Value *LHS = loadSymbolicMaskIndexMemory(In, Mask, Passthru, Lane, Builder);
