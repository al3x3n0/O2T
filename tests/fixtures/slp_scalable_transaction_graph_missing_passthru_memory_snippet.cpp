...
Value *loadScalableMissingPassthruMemory(Value **Base, Value **Mask,
                                         Value **Passthru,
                                         IRBuilder &Builder) {
...
void vectorizeScalableMissingPassthruMemoryTree(
  ...
  if (allSameOpcode(Entry, Instruction::Add) && isValidElementType(Entry) &&
    ...
    Value *LHS = loadScalableMissingPassthruMemory(In, Mask, Passthru, Builder);
