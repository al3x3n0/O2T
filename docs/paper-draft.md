...
interprocedural value flow — proving **428 of 715 of LLVM's own InstCombine test functions end-to-end
...
- **A second verification track: closed-loop translation validation of the real transform** (§6).
  ...
  fixed and scalable vectors, interprocedural value flow — reaching 428/715 of LLVM's own InstCombine
...
(`and/or/xor/add.ll`, 715 functions) **428 (60%) are proved sound end-to-end with zero false
refutations, and none of the 428 is vacuous**; the rest decline on shapes the translator does not
